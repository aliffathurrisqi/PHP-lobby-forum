...
('aliffathurrisqi','31032000Alif','Aliffathur Risqi Hidayat','Laki-Laki','Saya adalah Developer Forum Lobby, CEO Alfari Studio dan merupakan Mahasiswa Universitas Teknologi Yogyakarta','aliffathurrisqi20220412120035.jpg','2022-03-12',NULL,'user'),
...
insert  into `komentar`(`id`,`id_post`,`username`,`komentar`,`waktu`) values 
(1,3,'xannen','Kalo boleh jujur memang blunder sih, tapi posisi lemon terlalu kepepet dia berada di posisi yang salah juga','2022-03-12 22:04:33'),
(5,3,'aliffathurrisqi','karena penempatan posisi salah makanya jadi blunder gan.','2022-03-12 22:35:59'),
(9,4,'aliffathurrisqi','jujur aja gua liat GEEK FAM season ini emang agak aneh, mereka kek gak punya opsi strategi yang pas lebih banyak bikin antisipasi lawan daripada bikin gameplay mereka sendiri','2022-04-09 15:00:54'),
(12,4,'admin','mereka ketinggalan meta','2022-04-09 15:11:23'),
(13,1,'inocent','RRQ HOSHI !!!!!','2022-04-09 15:45:56'),
(14,5,'marukawa','asikk nature spirit jadi lebih enak sekarang','2022-04-09 16:21:54');
...
insert  into `laporan`(`id`,`pelapor`,`tipe_laporan`,`suspect`,`alasan`,`waktu`) values 
(1,'aliffathurrisqi','user','xannen','Pengguna ini melakukan penipuan','2022-04-03 12:55:05');
...
(41,'aliffathurrisqi',5,'2022-04-09 16:10:48'),
...
(3,'aliffathurrisqi','2022-03-12 21:24:53','Pertandingan el clasico yang mempertemukan RRQ Hoshi dengan EVOS Legend di weekend sebelumnya berlangsung seru. kedua tim sama-sama tidak mau kalah dan menampilkan permainan terbaik. Hingga skor menjadi 1-1, game ketiga menjadi penentuan siapa tim yang akhirnya memenangkan pertandingan. akan tetapi blunder yang dilakukan \"Lemon\" membuat RRQ Hoshi akhirnya ditumbangkan EVOS Legend.','5','Blunder  \"Lemon\" membuat RRQ  ditumbangkan EVOS'),
(4,'inocent','2022-04-09 01:47:00','MPL ID Season 9 sudah mau kelar. Tapi sampai sekarang GEEK FAM belum pernah menang lawan siapapun. Sebenarnya apa yang terjadi pada tim mereka?','17','Ada apa dengan GEEK FAM?'),
